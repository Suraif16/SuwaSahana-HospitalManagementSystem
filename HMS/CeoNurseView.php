...
<head>
    ...
    <link rel="stylesheet" href="CeoNurseView.css">
    <style>
        body {
...
<body>
    <div class="header">
        <h1 class="role">View Nurse Records</h1>
        ...
        <?php require_once('connection2.php');
            ...
            $query = "SELECT employee.Emp_ID, employee.Name, employee.Address,employee.Contact_No, employee.Working_status,medical_staff.Registered_ID, medical_staff.Joined_Date, medical_staff.Resigned_Date from employee inner join medical_staff  on employee.Emp_ID = medical_staff.Emp_ID where medical_staff_type='Nurse'" ;
